...
// This is the most reliable way to check for packaged vs development run
...
      // 🚀 DEVTOOLS FIX: Set devTools to true to ensure they can be opened.
      devTools: true 
    }
  });
...
    // 💡 DevTools will open here in dev mode
    mainWindow.webContents.openDevTools();
  } else {
    // Production mode: Load built files
    loadProductionApp(mainWindow);
    
    // 🚀 CRITICAL FIX: Explicitly open DevTools in production mode (packaged app).
    // This forces the DevTools window to appear on launch, allowing you to see
    // the console errors (e.g., Cesium worker/asset loading failures).
    mainWindow.webContents.openDevTools();
  }
...
    
    // ... (rest of the logging is unchanged)
  });
...
  // ❌ ORIGINAL PATH: path.join(__dirname, 'dist', 'index.html') -> "app.asar/electron/dist/index.html" (INCORRECT)
  // ✅ FIXED PATH: path.join(__dirname, '../dist/index.html') -> "app.asar/dist/index.html" (CORRECT)
