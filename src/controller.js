...
// Set CESIUM_BASE_URL to the relative path defined in electron-builder's extraResources.
// Since the app loads via file://, it must be relative path 'Cesium/' (the folder name).
// The path must not start with a slash in a packaged Electron app.
